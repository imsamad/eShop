        ...
        <Col md={6}>
                ...
                <ListGroup.Item key={review._id}>
                  <Row>
                    ...
                    <Col className="col-10">
                      <span>
                        <h6 className="my-0">{review.name}</h6>
                      </span>
                      <span>
                      ...
                      <p id="onHover" className="text-right my-0">
                        <div className="onHoverItems">
                          <Button
                            className="btn-sm p-1 px-2 btn-light mx-1"
                            title="Edit"
                          >
                            <i className="fa p-0 m-0 fa-edit"></i>
                          </Button>
                          <Button
                            className="btn-sm  p-1  px-2 btn-light mx-1"
                            title="Delete"
          ...
          {!userInfo ? (
            <Alert variant="info">
              Please
              <Link
                to={`/signin?redirect=product/${match.params.id}`}
                className="text-dark mx-1 btn btn-sm btn-light"
              >
                Sign In
              </Link>
              to write a review.
